...
- **ORM Prisma**: Foi utilizado ORM Prisma para a comunicação entre a API e o Postgres, garantindo segurança de tipos e agilidade no desenvolvimento das consultas
